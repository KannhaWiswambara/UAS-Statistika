<x-admin-layout>
    <!-- Navbar -->
    <nav class="flex flex-wrap items-center justify-between px-0 py-2 mx-6 transition-all shadow-none duration-250 ease-soft-in rounded-2xl" navbar-main navbar-scroll="true">
      ...
      <div>
        <h1 class="px-6 py-6 text-3xl font-bold">
          Welcome to Computer Science Undiksha Student Information System!
        </h1>
        <img src="./assets/img/undiksha.png" class="ml-64 inline h-full max-w-full transition-all duration-200 ease-nav-brand max-h-54" alt="main_logo" />
        <img src="./assets/img/FTK.png" class="inline h-full max-w-full transition-all duration-200 ease-nav-brand max-h-54" alt="main_logo" />
