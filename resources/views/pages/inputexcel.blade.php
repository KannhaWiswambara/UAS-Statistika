<x-admin-layout>
    ...
    <nav class="relative flex flex-wrap items-center justify-between px-0 py-2 mx-6 transition-all shadow-none duration-250 ease-soft-in rounded-2xl" navbar-main navbar-scroll="true">
      ...
      <form action="{{ route('importExcel') }}"
                                            ...
                                            <br>
                                            <button class=" mt-10 focus:outline-none mx-72 md-72 text-white bg-green-700 hover:bg-gray-800 focus:ring-4 focus:ring-green-300 font-medium rounded-20 text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-teal-600 dark:hover:bg-teal-700 dark:focus:ring-teal-800 btn btn-success">
                                            @lang('Import')
                                            Data
                                            </button>
                                    </form>
